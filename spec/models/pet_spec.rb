...
# Unit tests for BulletTrainTest::Pet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BulletTrainTest::Pet do
  let(:instance) { BulletTrainTest::Pet.new }

  describe 'test an instance of Pet' do
    it 'should create an instance of Pet' do
      expect(instance).to be_instance_of(BulletTrainTest::Pet)
    end
  end

# BulletTrainTest::NApi

All URIs are relative to *https://bullettrainapi.eu.ngrok.io/api/v1*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**post_team_project_tags**](NApi.md#post_team_project_tags) | **POST** /teams/{team_id}/projects/tags |  |
...
begin
  ...
  puts "Error when calling NApi->post_team_project_tags: #{e}"
end
```
...
begin
  ...
  puts "Error when calling NApi->post_team_project_tags_with_http_info: #{e}"
end
```

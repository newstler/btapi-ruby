...
module BulletTrainTest
  class TeamsApi
    ...
    def get_teams_team_id_projects_with_http_info(team_id, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{teamId}/projects'.sub('{' + 'team_id' + '}', CGI.escape(team_id.to_s))
    ...
    def get_teams_team_id_projects_three_with_http_info(team_id, opts = {})
      ...
      # resource path
      local_var_path = '/teams/{teamId}/projects/three'.sub('{' + 'team_id' + '}', CGI.escape(team_id.to_s))

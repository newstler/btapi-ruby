...
module BulletTrainTest
  class ApiV1ScaffoldingCompletelyConcreteTangibleThingSerializerDataAttributes
    attr_accessor :id

    attr_accessor :absolutely_abstract_creative_concept_id

    attr_accessor :text_field_value

    attr_accessor :button_value

    attr_accessor :color_picker_value
    ...
    def self.attribute_map
      {
        :'id' => :'id',
        :'absolutely_abstract_creative_concept_id' => :'absolutely_abstract_creative_concept_id',
    ...
    def self.openapi_types
      {
        :'id' => :'Integer',
        :'absolutely_abstract_creative_concept_id' => :'Integer',
        :'text_field_value' => :'String',
        :'button_value' => :'String',
        :'color_picker_value' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BulletTrainTest::ApiV1ScaffoldingCompletelyConcreteTangibleThingSerializerDataAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BulletTrainTest::ApiV1ScaffoldingCompletelyConcreteTangibleThingSerializerDataAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'absolutely_abstract_creative_concept_id')
        self.absolutely_abstract_creative_concept_id = attributes[:'absolutely_abstract_creative_concept_id']
      end
      ...
      if attributes.key?(:'color_picker_value')
        self.color_picker_value = attributes[:'color_picker_value']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          absolutely_abstract_creative_concept_id == o.absolutely_abstract_creative_concept_id &&
          text_field_value == o.text_field_value &&
          button_value == o.button_value &&
          color_picker_value == o.color_picker_value &&
    ...
    def hash
      [id, absolutely_abstract_creative_concept_id, text_field_value, button_value, color_picker_value, cloudinary_image_value, date_field_value, date_and_time_field_value, email_field_value, password_field_value, phone_field_value, option_value, super_select_value, created_at, updated_at].hash
    end
